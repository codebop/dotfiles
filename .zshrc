...
alias everspring="aem use everspring && source $HOME/.boto/boto_credentials.sh && export AWS_PROFILE_ZSH='everspring'"
alias everspring-OR="aem use everspring-OR && source $HOME/.boto/boto_credentials.sh && export AWS_PROFILE_ZSH='everspring-OR'"
alias colloquy_all="aem use colloquy_all && source $HOME/.boto/boto_credentials.sh && export AWS_PROFILE_ZSH='colloquy_all'"
alias colloquy_s3="aem use colloquy_s3 && source $HOME/.boto/boto_credentials.sh && AWS_PROFILE_ZSH='colloquy_s3'"
